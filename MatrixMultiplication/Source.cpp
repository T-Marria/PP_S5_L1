...
int main() {
	...
	const char* path1 = "E:\\programming\\matrix1.txt";
	const char* path2 = "E:\\programming\\matrix2.txt";
	...
	int** m2 = ReadMatrix(path2, r2, c2);
		...
		ofstream R;
		R.open("E:\\programming\\result.txt");
		...
		ofstream measurements, m;
		measurements.open("E:\\programming\\m.xls", ios::app);
		measurements << SIZE << "\t" << mulTime << endl;
		measurements.close();

		m.open("E:\\programming\\m.txt", ios::app);
		m << SIZE << "\t" << mulTime << endl;
		m.close();
